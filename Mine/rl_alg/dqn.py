...
class SoftPoolingGcnEncoder(GcnEncoderGraph):
    ...
    def forward(self, x, adj, batch_num_nodes=None,compute_loss=True, **kwargs):
        ...
        for i in range(self.num_pooling):
            ...
            self.assign_tensor = F.softmax(self.gcn_forward(x_a, adj, 
                    ...
                    embedding_mask), -1)
            print('\n\nType:')
            print(type(self.assign_tensor))
            print('\n\n\nLine 258: self.assign_tensor')
            ...
            print('\n\n\n\n')
            print('temp_tensor transposed')
            print('type:')
            print(type(torch.transpose(temp_tensor, 0,1)))
            print('size:')
    ...
    def loss(self, adj=None, batch_num_nodes=None, adj_hop=1):
        ...
        print('-------------DEBUG----------------\n\n\n\n')
        print('Line 258: self.assign_tensor')
        print('Type:')
        print(type(self.assign_tensor))
        print('size:')
        print(self.assign_tensor.size())
        print('\n\n\n\n')
        print('torch.transpose(self.assign_tensor, 1, 2)')
        print('Type:')
        print(type(torch.transpose(self.assign_tensor, 1, 2)))
        print('size:')
        ...
        if batch_num_nodes is None:
            ...
            adj_mask = embedding_mask.mm(torch.transpose(embedding_mask, 1, 2))

...
class Buffer:
    ...
    def __init__(self, max_size=1000, seed=None):
        self.buffer = deque(maxlen=max_size) # A queue from both ends. Both append and pop adds or removes elements from right. Appendleft and popleft for left side
...
# AS USED IN 'train.py'
# PriortizedReplay(BUFF_SIZE, 10, beta=0.6)

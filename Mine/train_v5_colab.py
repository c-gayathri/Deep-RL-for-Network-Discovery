...
g_paths = [
    'Mine/data/rt/copen.pkl',
    #'data/rt/occupy.pkl'
]

gpickle_path = 'Mine/sbm_700.gpickle' # p_in = 0.005; p_out = 0.001
...
if __name__ == "__main__":
    ...
    try:
        ...
        with open(file_name, 'a') as file: 
                file.write('\n\n!Params: fairness - ' + str(fairness) + '; budget - ' + str(budget) + '; extra-seeds - ' + str(extra_seeds) + '; alpha - ' + str(alpha) + '; factor - ' + str(factor) + '; samples - ' + str(samples) + '; graph size - ' + str(len(g)) + '; p_in - ' + str(p_in) + '; p_out - ' + str(p_out))
        ...
        for ep in range(NUM_EP):
            ...
            outputs = [str(epTime), str(inf), str(discBand), str(sprBand), str(comDisc), str(comSpread)]
